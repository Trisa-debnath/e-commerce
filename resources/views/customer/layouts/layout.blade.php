...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Customer
          </span>
        </a>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Customer-history</span>
            </a>
					</li>
					
					<li class="sidebar-item {{request()->routeIs('customer.payment')?'active':''}}">
						<a class="sidebar-link" href="{{route('customer.payment')}}">
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Customer-payment</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle"> Affiliate</span>
            </a>
					</li>	
