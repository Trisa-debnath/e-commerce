...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card text-white bg-danger shadow-sm border-0 rounded-3 h-100">
        <div class="card-body">
            <h4 class="fw-bold mb-1">{{$total_user}}</h4>
    ...
    <div class="card text-white bg-success shadow-sm border-0 rounded-3 h-100">
        <div class="card-body">
            <h4 class="fw-bold mb-1">{{$total_revenue}}</h4>
...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card text-white bg-primary shadow-sm border-0 rounded-3 h-100">
        <div class="card-body">
            <h4 class="fw-bold mb-1">{{$total_deleverd}}</h4>
...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card text-white bg-danger shadow-sm border-0 rounded-3 h-100">
        <div class="card-body">
            <h4 class="fw-bold mb-1">{{$total_pending}}</h4>
            ...
            <div class="card shadow-sm border-0 rounded-3 h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <h4 class="fw-bold mb-1 text-dark">{{$total_cancelled}}</h4>
                        </div>
