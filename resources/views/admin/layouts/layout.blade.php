...
<li class="sidebar-header">
              ...
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Subcategory create</span>
            </a>
					</li>
						<li class="sidebar-item {{request()->routeIs('subcategory.manage')?'active':''}}">
						<a class="sidebar-link" href="{{route('subcategory.manage')}}">
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Subcategory manage</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="shopping-bag"></i> <span class="align-middle">Product manage</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="star"></i> <span class="align-middle">Manage-product-review</span>
            </a>
					</li>
...
<li class="sidebar-header">
              ...
              <i class="align-middle" data-feather="plas"></i> <span class="align-middle">Product-attribute create</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Product-attribute manage</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="plas"></i> <span class="align-middle">Discount create</span>
            </a>
					</li>
						<li class="sidebar-item {{request()->routeIs('discount.manage')?'active':''}}">
						<a class="sidebar-link" href="{{route('discount.manage')}}">
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Discount manage</span>
            </a>
					</li>

<li class="sidebar-item {{request()->routeIs('admin.seeting')?'active':''}}">
						<a class="sidebar-link" href="{{route('admin.seeting')}}">
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">Seeting</span>
            </a>
					</li>
                ...
                <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<form action="route('logout')" method="POST">
                                 @csrf
								 <input type="submit" class="btn -btn bg-danger" value="Logout">
								</form>
							</div>
						</li>
					</ul>
